...
const FAQ = [
  ...
  ['Does VA disability count as income for a mortgage?', 'Yes. It counts as effective income and, per the Lender\'s Handbook, needs no continuance documentation the way wages do. Because it\'s tax-free, the Lender\'s Handbook tells lenders to gross it up to 125% for the DTI test (Ch. 4, Topic 9); some lenders apply less under their own overlays. Residual income is always real cash, never grossed up; the Handbook allows grossing up for the DTI ratio only.'],
